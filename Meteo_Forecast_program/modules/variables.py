...
path_source_files = "/Meteo_Forecast_program/source_files/" # Enter path to source file directory from curent dir where python program is exectuted
...
path_folder_csv = wd+"/Meteo_Forecast_program/forecast_data/"
